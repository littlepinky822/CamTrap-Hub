    ...
    return (
        <div className='navbar bg-base'>
            <div className='flex-1'>
                <a className='btn btn-ghost text-2xl text-primary' onClick={() => window.location.href = '/'}>CamTrap Hub</a>
            </div>
            <div className='flex-none'>
                <label className="swap swap-rotate">
                    {/* this hidden checkbox controls the state */}
                    <input type="checkbox" className="theme-controller" value="synthwave" onChange={toogleTheme} checked={theme === 'night'}/>
